...
export const systemTypes: SystemType[] = [
  ...
  },
  {
    ...
    tradeoffs: [
      ...
      "No fluoride or heavy metal removal",
      "May need a separate reverse osmosis or under-sink carbon filter",
    ],
    icon: "home",
  },
  {
  ...
  },
  {
    ...
    tradeoffs: [
      ...
      "Usually needs a separate under-sink carbon or reverse osmosis filter",
    ],
    icon: "waves",
  },
  {
    ...
    priceRange: "$4,000 – $6,000 installed",
    maintenance: "Multiple filter sets to maintain. Annual cost typically $400–$600 depending on system components.",
    pros: [
