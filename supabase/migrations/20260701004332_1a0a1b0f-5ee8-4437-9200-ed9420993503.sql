...
ALTER TABLE public.providers
  ADD COLUMN IF NOT EXISTS accepts_rental_leads boolean NOT NULL DEFAULT true;
...
CREATE OR REPLACE FUNCTION public.get_matched_vendors(
  ...
  _is_rental boolean DEFAULT false
)
...
GRANT EXECUTE ON FUNCTION public.get_matched_vendors(numeric, numeric, text, text[], integer, boolean) TO anon, authenticated;
